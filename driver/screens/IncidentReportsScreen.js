// screens/IncidentReportsScreen.js
...
export default function IncidentReportsScreen() {
  ...
  return (
    <OptionsScreenContainer>
      <OptionsScreenHeader title="Incident Reports" />
      <View style={styles.center}>
        <Ionicons name="warning-outline" size={48} color={T.textMuted} />
        <Text style={[styles.text, { color: T.textMuted }]}>
          Log and review route incidents.
        </Text>
