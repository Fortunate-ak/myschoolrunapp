...
// ── Icon map ──────────────────────────────────────────────────────────────────
// Colors here are static; we'll override the system color with the theme later.
const ICON_MAP = {
  request: {
  ...
  system: {
    ...
    color: null, // will be replaced with theme textMuted
...
function NotifCard({ item, onPress, T }) {
  ...
  // Override system color with theme textMuted
  const iconColor = item.type === "system" ? T.textMuted : meta.color;
  ...
  return (
    <TouchableOpacity
      style={[
        ...
        !item.isRead && { borderColor: T.accentBorder },
      ]}
...
export function NotificationBadge({ count, style }) {
  ...
  return (
    <View style={[styles.badge, { backgroundColor: T.accent }, style]}>
      ...
      >
        ...
        <View style={styles.headerCenter}>
          <View style={styles.headerTitleRow}>
            ...
            <NotificationBadge count={unreadCount} style={styles.titleBadge} />
          </View>
